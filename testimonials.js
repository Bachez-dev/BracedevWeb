    const testimonials = [
      {
        quote: "Exceeded our expectations with innovative designs.",
        name: "Samantha",
        role: "CEO",
    ...
    function setupHorizontalScroll(containerId, speed = 0.5, direction = "left") {
      const container = document.getElementById(containerId);
      const cardsHTML = testimonials.map(createCard).join('');
      container.innerHTML = cardsHTML + cardsHTML; // duplicate for infinite loop
    ...
    // Three rows, alternating directions
    setupHorizontalScroll('track1', 0.6, "left");
    setupHorizontalScroll('track2', 0.8, "right");